package me.jamie.advanced.trace.hellotrace;
...
public class HelloTraceV2 {
    ...
    public TraceStatus begin(String message) {
        ...
        return createTraceStatus(traceId, message);
    }

    public TraceStatus beginSync(TraceId beforeTraceId, String message) {
        TraceId nextTraceId = beforeTraceId.createNextId();
        return createTraceStatus(nextTraceId, message);
    }

    private TraceStatus createTraceStatus(TraceId traceId, String message) {
